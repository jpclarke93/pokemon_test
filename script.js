...
let pkmList = [
  ['Charizard', 'https://img.pokemondb.net/sprites/black-white/anim/back-shiny/charizard.gif', 360, [
      ...
      if (rtype[i].includes(mtype)) {
        switch (i) {
          ...
          case 1:
            scale = 2;
            setTimeout(function() {
              document.getElementById('comment').innerHTML = '<p>It was supper effective!</p>';
            },1000);
            break;
          case 2:
            scale = 0.5;
